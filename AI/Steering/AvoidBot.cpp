...
AvoidBot::AvoidBot(AI::AIWorld& world)
	: BaseBot(world)
{
	m_steering.AddBehaviour<AI::AvoidBehaviour>();
	m_steering.GetBehaviour<AI::AvoidBehaviour>("Avoid")->SetActive(true);
...
void AvoidBot::Update(float deltaTime)
{	
...
void AvoidBot::SetTarget(const X::Math::Vector2& target)
{
	m_agent.Destination() = target;
}

void AvoidBot::SetRotation()
{
