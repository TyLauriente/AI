...
struct LineSegment
{
	...
	bool operator==(const LineSegment& other) { return (from == other.from) && (to == other.to); }
};
...
struct Circle
{
	...
	bool operator==(const Circle& other) const { return (this->center == other.center) && (this->radius == other.radius); }
};
